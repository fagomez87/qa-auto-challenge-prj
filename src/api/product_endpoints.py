...
class AddProductToCart(Resource):
    def post(self, username, product_name):
        ...
        if results_from_inventory:
            ...
            results_from_cart = db.search(db.cart, query=(db.query.product_name == product_name))
            ...
            if product.get('product_qty') >= needed_qty:
                ...
                if results_from_cart:
                    db.update(table=db.cart, update={'product_qty': needed_qty}, query=(db.query.product_name == product_name))
                else:
